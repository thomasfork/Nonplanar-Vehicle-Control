...
from vehicle_3d.models.tangent_vehicle_model import VehicleModelConfig, \
    DynamicTwoTrackSlipInputVehicleModel
...
class SlipInputRaceline(BaseRaceline):
    ''' two track slip input raceline '''
    ...
    def _get_model(self) -> DynamicTwoTrackSlipInputVehicleModel:
        return DynamicTwoTrackSlipInputVehicleModel(self.model_config, self.surf)
...
class PlanarSlipInputRaceline(SlipInputRaceline, BasePlanarRaceline):
    ''' planar two track slip input raceline '''
